 ...
 */
export function generateRandomDescription(minLength, maxLength) {
    ...
    const startIndex = Math.floor(Math.random() * (loremIpsum.length - length));
    const description = loremIpsum.substring(startIndex, length);
